...
const GetApp = () => {
  return (
    ...
    style={{backgroundImage:'url(./Assets/images/blueTexture.png)'}}>
      ...
      <div className='flex flex-col justify-items-end gap-4 auto overflow-hidden'>
          <div className='flex flex-row gap-2'>
            <Link href='/'>
            <Image className='w-full h-auto'  src='/Assets/icons/App-Store.svg' alt='app-store' width={150} height={50}/>
            </Link>
            <Link href='/'>
            <Image className='w-full h-auto' src='/Assets/icons/Google-play.svg' alt='google-play' width={150} height={50}/>
            </Link>
          </div>
